...
REM
REM Generated by Vivado on Mon Oct 24 22:52:35 -0700 2022
...
echo "xvlog --incr --relax -L uvm -prj OTTER_SIM_vlog.prj"
call xvlog  --incr --relax -L uvm -prj OTTER_SIM_vlog.prj -log xvlog.log
