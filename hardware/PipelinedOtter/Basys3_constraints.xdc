...
#Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {SPI_TFT_CS}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SPI_TFT_CS}]
#Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {SPI_SDI}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SPI_SDI}]
#Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {SPI_SDO}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SPI_SDO}]
##Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports {SPI_SD_CS}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SPI_SD_CS}]
##Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {TFT_DC}]					
